...
public enum ErrorMessage {
    ...
    INITIAL_GOLD_QUANTITY_INVALID("The initial gold quantity is invalid. Please enter a whole number."),
    ...
    SECOND_COORDINATE_MISSING("The %s command is missing its second coordinate."),
    INVALID_VEGETABLE_NAME("Invalid vegetable name for %s command. A vegetable with the name %s doesn't exist."),
    INVALID_COORDINATES("Please enter integers for the coordinates."),
    INVALID_VEGETABLE_QUANTITY("Please enter zero or positive amount of vegetables."),
